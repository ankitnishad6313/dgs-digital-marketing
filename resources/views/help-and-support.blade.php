                ...
                <div class="col-lg-8 m-auto">
                    <div class="about-inner-header heading9 text-center">
                        ...
                        <a href="{{ route('home') }}">Home <i class="fa-solid fa-angle-right"></i> Services <i
                                class="fa-solid fa-angle-right"></i> <span>Help and Support</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="service-content heading2">
                        ...
                        <p>Welcome to SEOC’s Help and Support Services. Our team specializes in crafting and executing
