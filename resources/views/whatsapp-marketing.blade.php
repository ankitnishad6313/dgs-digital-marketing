                ...
                <div class="col-lg-8 m-auto">
                    <div class="about-inner-header heading9 text-center">
                        ...
                        <a href="{{ route('home') }}">Home <i class="fa-solid fa-angle-right"></i> Services <i
                                class="fa-solid fa-angle-right"></i> <span>WhatsApp Marketing</span></a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5">
                    <div class="service-content heading2">
                        ...
                        <p>Welcome to SEOC’s WhatsApp Marketing Services. Our team specializes in crafting and executing
                            WhatsApp strategies that elevate your brand, engage your audience, and drive measurable
                            results. Harness the power of WhatsApp to grow your business and connect with customers on a
                            deeper level.</p>
                ...
                <div class="col-lg-12">
                    <div class="service-all-boxes-area">
                        ...
                        <div class="service-boxarea box3">
                            ...
                            <div class="space40"></div>
                            <p>Build a strong brand presence and engage with your audience on WhatsApp platforms. We
                                create strategic WhatsApp campaigns to boost brand.</p>
                        </div>
